...
**Related Documents:**  
- Attract Mode Showcase Narrative (Business Requirements & Messaging)  
- Attract Mode Technical Requirements & Control Specification (forthcoming)
...
- Visually subordinate to primary elements  
...
**Governance Note**  
Approved badge wording and its business interpretation are defined in the **Attract Mode Showcase Narrative** and must not be altered during design or implementation.

**Explicit Prohibitions**
- No asterisks  
- No footnotes  
- No tooltips  
- No defensive or disclaimer-style language  
...
Without listing specifications, the UI should subtly imply:
...
- RUNNING models emit slightly more visual energy  
- Capacity indicator badge remains calm and static  
...
### Visual Variability Note

Scene C visual intensity (e.g., motion energy, glow strength, background activity) may vary based on real-time system state and operational context.  

Such variations must:
- Remain within the same visual language  
- Preserve the same narrative intent  
- Never introduce new visual elements  
- Never alter the scene’s structure or message  

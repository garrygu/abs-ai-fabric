...
class DocumentService:
        ...
        try:
            ...
            async with self.pool.acquire() as conn:
                async with conn.transaction():
                    # Insert document record (id will be auto-generated by PostgreSQL)
    ...
    async def update_document(
        ...
        try:
            ...
            allowed_fields = {
                'status', 'metadata', 'analysis_timestamp', 'file_path'
            }
            ...
            async with self.pool.acquire() as conn:
                async with conn.transaction():
                    ...
                    analysis_row = await conn.fetchrow("""
                        ...
                        (id, document_id, analysis_type, analysis_data, model_used, processing_time_ms, confidence_score)
                    ...
                    """, analysis_id, document_id, analysis_type, json.dumps(analysis_data), 
                    ...
                    await conn.execute("""
                        ...
                        VALUES ($1, $2, $3, $4, $5, $6)
                    """, log_id, user_id, 'analysis_created', 'analysis_result', str(analysis_id), 
